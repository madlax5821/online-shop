    ...
    $(function(){
    	// 点击切换页面
	     $("#product-type-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/productType/getAllTypes");
        });
        $("#product-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/product/getAllProducts");
        });
        $("#user-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/customer/getAllCustomers");
        });
        $("#manager-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/admin/getAllAdmins");
        });
    });
    function logout(loginName) {
        $.post("${pageContext.request.contextPath}/backend/admin/logout",{
            "loginName":'xiaofei'
        })
    }
    </script>
            ...
            <div class="clear-bottom head">
                <div class="container head-cc">
                    ...
                    <div class="welcome">
                        ...
                        <div class="exit" onclick="logout('${loginName}')">退出</div>
                    </div>
                </div>
            </div>
            <!-- header end -->
            ...
            <div class="container-flude flude-cc" id="a">
                <div class="row user-setting">
                    ...
                    <div class="col-xs-10" id="userPanel">
                        <iframe id="frame-id" src="${pageContext.request.contextPath}/backend/productType/getAllTypes" width="100%" height="100%" frameborder="0" scrolling="no">
                        </iframe>
                    </div>
