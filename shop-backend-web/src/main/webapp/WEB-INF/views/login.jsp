...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/bootstrap-validator.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/layer/layer.js"></script>

	<script>
		function reloadImage(){
			$("#randomCode").attr('src','${pageContext.request.contextPath}/backend/code/image?time'+new Date().getTime());
			$("#code").val('');
		}
    ...
    <div class="container div-signin">
      <div class="panel panel-primary div-shadow">
	    ...
	    <div class="panel-body">
	      <!-- login form start -->
	      <form action="${pageContext.request.contextPath}/backend/admin/login" class="form-horizontal" method="post" id="loginForm">
		     <div class="form-group">
		       <label class="col-sm-3 control-label">用户名：</label>
		       <div class="col-sm-9">
		         <input class="form-control" id="loginName" type="text" name="loginName" placeholder="请输入用户名">
		       </div>
		    </div>
		     <div class="form-group">
		     ...
		     <div class="form-group">
		       ...
		       <div class="col-sm-2">
		       	  <!-- 验证码 -->
			      <img class="img-rounded" src="${pageContext.request.contextPath}/backend/code/image" id="randomCode" style="height: 32px; width: 70px;"/>
		       </div>
		       <div class="col-sm-2">
